...
<html>
	...
	<body>
		...
		<a href="/schedule?id=${employee.id}" class="btn btn-info">Back to ${employee.firstname}'s Schedule</a>
		<h3>Pick up a new shift for</h3>
...
<br><br><h4>Your current shifts:</h4><br>
